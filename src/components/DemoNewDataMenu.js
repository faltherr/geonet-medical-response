...
class DemoNewDataMenu extends Component {
  constructor() {
    super()
    this.state = {
      patientName: '',
...
export default connect(mapStateToProps, { getHealthworkers, addPatientSurvey, getOutposts, addHCW, addOutpost })(DemoNewDataMenu)
